...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  double getTotalPrice() {
    if(widget.groceryItem.name == "Kashmiri Apple"){
      return amount * double.parse(widget.recommendApplePrice);
    }else if(widget.groceryItem.name == "Organic Bananas"){
      return amount * double.parse(widget.recommendBananaPrice);
    }else if(widget.groceryItem.name == "Hair Saloon"){
      return amount * double.parse(widget.recommendHairCutPrice);
    }else if(widget.groceryItem.name == "Spa and Beauty"){
      return amount * double.parse(widget.recommendSpaPrice);
    }else if(widget.groceryItem.name == "Brown Bread"){
      return amount * double.parse(widget.recommendBreadPrice);
    }else{
      return amount * double.parse(widget.recommendMilkPrice);
    }
  }
}
